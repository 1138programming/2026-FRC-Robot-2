...
public class AimFlywheelPoseAndIndex extends Command {
  Shooter shooter;
  ShooterLogic logic;
  Indexer indexer;
  Supplier<Pose3d> target;
  /** Creates a new SetShooterRPM. */
  public AimFlywheelPoseAndIndex(Shooter shooter, Indexer indexer, ShooterLogic logic, Supplier<Pose3d> target) {
