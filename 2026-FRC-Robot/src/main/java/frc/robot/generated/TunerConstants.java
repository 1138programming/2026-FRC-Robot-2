...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(1.5).withKI(0).withKD(0)  // Matches other robot - works well with same motors/swerves
        .withKS(0.22027).withKV(0.68053);  // Tuned for heavier robot weight
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Supply (bus) current limit protects battery and prevents brownouts
                .withSupplyCurrentLimit(Amps.of(50))
                .withSupplyCurrentThreshold(Amps.of(65))  // Allow brief spikes for acceleration
                .withSupplyTimeThreshold(0.5)  // Must exceed threshold for 0.5s to trigger limit
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.446044921875);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.0244140625);
