...
public class AutoRotateToPose extends ParallelCommandGroup {
  /** Creates a new AutoShoot. */
  public AutoRotateToPose(ShooterLogic shooterLogic, Shooter shooter, Drive drive, Supplier<Pose3d> target, DoubleSupplier xSupplier, DoubleSupplier ySupplier) {
