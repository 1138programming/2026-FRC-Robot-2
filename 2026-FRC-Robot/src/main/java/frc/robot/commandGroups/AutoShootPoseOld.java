...
@Deprecated
public class AutoShootPoseOld extends ParallelCommandGroup {
  /** Creates a new AutoShoot. */
  public AutoShootPoseOld(ShooterLogic shooterLogic, Shooter shooter, Drive drive, Pose3d target, DoubleSupplier xSupplier, DoubleSupplier ySupplier) {
